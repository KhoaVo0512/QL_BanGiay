...
{
    public class NikeRepo : INike
    {
        private readonly QlyBanGiayContext _context;
        public NikeRepo(QlyBanGiayContext context)
        {
            _context = context;
        }
        ...
        public PaginatedList<Giay> GetItemsNike(string SortProperty, SortOrder sortOrder, string SearchText = "", int pageIndex = 1, int pageSize = 12)
        {
            List<Giay> items;
            ...
            if (SearchText != "" && SearchText != null)
            {
                ...
                items = _context.Giays.Where(s => s.MaDongSanPhamNavigation.MaNhanHieuNavigation.MaNhanHieu == 4 && s.GiaBan != null && s.TrangThai == true).ToList();
        ...
        public PaginatedList<Giay> GetItemsNikeCollection(string namecollection, string SortProperty, SortOrder sortOrder, string SearchText = "", int pageIndex = 1, int pageSize = 12)
        {
            List<Giay> items;
