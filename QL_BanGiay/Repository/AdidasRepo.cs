...
namespace QL_BanGiay.Repository
{
    public class AdidasRepo : IAdidas
    {
        ...
        public PaginatedList<Giay> GetItemsAdidas(string SortProperty, SortOrder sortOrder, string SearchText = "", int pageIndex = 1, int pageSize = 5)
        {
            List<Giay> items;
        ...
        public PaginatedList<Giay> GetItemsAdidasCollection(string namecollection,string SortProperty, SortOrder sortOrder, string SearchText = "", int pageIndex = 1, int pageSize = 6)
        {
            List<Giay> items;
